...
| 系统 | 安装包 |
| --- | --- |
| Windows 10/11 x64 | [video-toolkit-windows-x64-v1.7.13.zip](https://github.com/secure-artifacts/video-toolkit/releases/download/v1.7.13/video-toolkit-windows-x64-v1.7.13.zip) · [安装包 Setup](https://github.com/secure-artifacts/video-toolkit/releases/download/v1.7.13/VideoToolkit_Setup_v1.7.13.exe) |
| macOS Apple Silicon | [video-toolkit-macos-arm64-v1.7.13.zip](https://github.com/secure-artifacts/video-toolkit/releases/download/v1.7.13/video-toolkit-macos-arm64-v1.7.13.zip) |
| macOS Intel | [video-toolkit-macos-x64-v1.7.13.zip](https://github.com/secure-artifacts/video-toolkit/releases/download/v1.7.13/video-toolkit-macos-x64-v1.7.13.zip) |
